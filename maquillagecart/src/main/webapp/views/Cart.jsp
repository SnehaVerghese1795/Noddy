...
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
	<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						...
						<td>{{items.quantity}}</td>
							...
							<td class="actions" data-th="">
								...
								<button class="btn btn-danger btn-sm" ng-click="removeItemFromCart('${items.id}')"><i class="fa fa-trash-o"></i></button>								
							</td>
						</tr>
					</tbody>
					<tfoot>
				...
				<a href="<spring:url value="/" />" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a>
				<a href="<spring:url value="/billingAddress"/>" class="btn btn-success center">Checkout <i class="fa fa-angle-right"></i></a>
							<a  class="btn btn-danger center" ng-click="clearCartItems()"><span
                        class="fa fa-times"></span>Clear Cart</a>
